...
namespace EotE_GMTool.Objects.Characters.Species {
    public class Bothan : Species {
        public Bothan()
        {
            ...
            SpecialAbilities = new List<string>() {"Bothans begin the game with one rank in Streetwise.  They still may not train Streetwise above rank 2 during character creation."};
            StartingBrawn = 1;
            StartingPresence = 2;
            StartingIntellect = 2;
            StartingCunning = 3;
